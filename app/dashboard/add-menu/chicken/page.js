...
const ChickenForm = () => {
  ...
  const handleSubmit = () => {
    ...
    axios
      .post(
        `${apiUrl}/api/v1/add-menu/chickens`,
        { ...chickenData, image: imageBase64Data },
        {
  ...
  let handleDelete = (_id) => {
    axios
      .post(
        `${apiUrl}/api/v1/add-menu/deletechicken`,
        {
          id: _id,
        },
        { auth: { username: "user", password: postToken } },
      ...
      .then(() => {
        toast.success("Chicken Item Deleted Successfully!");
        setDataReFatch(!dataReFatch);
      });
  };
  ...
  useEffect(() => {
    axios
      .get(`${apiUrl}/api/v1/add-menu/getchickens`, {
        auth: {
          username: "user",
          password: getToken,
        },
  ...
  let handleUpdate = () => {
    axios
      .post(
        `${apiUrl}/api/v1/add-menu/updatechicken`,
        {
          id: editID,
          updatedChicken: { ...chickenData, image: imageBase64Data },
        },
        { auth: { username: "user", password: postToken } },
      )
      .then((res) => {
  ...
  let handleNotAvailable = (_id) => {
    axios
      .post(
        `${apiUrl}/api/v1/add-menu/chickenstatus`,
        {
          id: _id,
